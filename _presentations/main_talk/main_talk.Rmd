...
2. Space-filling grid search over sensible ranges of the hyperparameters.

3. Refine the grid as often as needed.
...
Tuning only two hyperparameters at once is easy to visualize:

```{r, echo=FALSE, out.width="90%", fig.align='center'}
knitr::include_graphics(paste0(dirname(dirname(getwd())),"/_pictures/bout_tuning_stumpsVs6.png"))
```

So the number of trees is now fixed with a value of 1500.
...
The value 600 seems appropriate.

---
## A look at learning rates
