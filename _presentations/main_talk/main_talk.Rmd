...
* The current model $\phi_{k-1}(\textbf{x})$
...
Model for the burnout data with the RMSE loss, fixed $K = 2$ and tree depth 1.
...
```{r,echo=FALSE, fig., cache=TRUE, include=FALSE}
...
Besides the standard value of six<sup>*</sup> for the maximum tree depth also the influence of considering just stumps is displayed.
