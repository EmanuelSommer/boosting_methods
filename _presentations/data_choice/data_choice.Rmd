...
Baseline linear model gives roughly  $R^2$ of 0.92
...
The training dataset contains `r ncol(obesity_data)` variables and `r nrow(obesity_data)` rows.<sup>*</sup>
...
Baseline linear model gives roughly  $R^2$ of 0.96
...
**Favourite** from these: Burnout dataset
