...
# XGBoost workflow with the untransformed data
bout_boost_wflow <-
  workflow() %>%
  add_model(bout_boost_model) %>%
  add_recipe(burnout_rec_boost)

# XGBoost workflow with the transformed data (empirical logit)
...
miss_vals_burn1
miss_vals_burn2
ggsave("_pictures/miss_vals_burn1.png", plot = miss_vals_burn1)
ggsave("_pictures/miss_vals_burn2.png", plot = miss_vals_burn2)
remove(miss_vals_burn1, miss_vals_burn2)
```
